...
# [Status: Total System Restoration - ZERO OMISSION - 30.7 KB]
...
# [Status: Modified - Enhanced for iPhone Visibility]
st.set_page_config(
...
# [Modified] 아이폰 전용 아이콘 인젝션 강화 (연두색 지구본 로고)
st.markdown("""
    <head>
        <link rel="apple-touch-icon" href="https://img.icons8.com/color/512/globe--v1.png">
        <link rel="apple-touch-icon" sizes="152x152" href="https://img.icons8.com/color/152/globe--v1.png">
        <link rel="apple-touch-icon" sizes="180x180" href="https://img.icons8.com/color/180/globe--v1.png">
        <link rel="apple-touch-icon" sizes="167x167" href="https://img.icons8.com/color/167/globe--v1.png">
...
# [Status: Restored and Expanded for 100% Reliability]
...
def calculate_running_totals(df):
    """[Restored] 구글 시트 누계 컬럼 I, J, K를 명시적으로 계산합니다."""
    temp_df = df.copy()
...
# [Status: Restored and Structural Hardening Applied]
st.title("🌏 여행 가계부 (GTL v1.30)")
    ...
    if mode == "일반 지출":
        ...
        if cat in ["입국", "출국"]:
            ...
            with col_m2:
                ...
                # [CORE FIX: Reactive FIFO Rate Injection]
