# [Project: Phu Quoc Strategic Ledger / Version: v26.04.20.026]
# [Module A, B, C, D: Fully Restored & Integrated]
# Total Line Count: 662
...
def calculate_quad_balances(df):
    ...
    # 1. 한국계좌 총 인출액 (충전/환전 시 지불한 KRW 합계)
    bank_actions = df_c[df_c['Category'].isin(['충전', '환전'])]
...
# --- 4. [Module C] UI: Sidebar (Rate Manager & Status) ---
with st.sidebar:
...
with tab_input:
    ...
    if mode == "일반 지출":
        ...
        with col1:
            ...
            sel_rate_str = st.selectbox("적용 환율", rate_opts, key="exp_rate")
